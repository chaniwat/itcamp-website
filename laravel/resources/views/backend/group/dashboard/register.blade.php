                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="small-box bg-section-{{ $staff->section->name }}" style="margin-bottom: 0;">
                                    ...
                                    <div class="small-box-footer" style="padding: 0; border-top: 5px solid whitesmoke;">
                                        <div class="progress progress-ms bg-gray active" style="margin-bottom: 0;">
                                            <div class="progress-bar progress-bar-striped progress-bar-fCamp" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: {{ sprintf("%.2f", $section_total_amount != 0 ? ($finish_amount / $section_total_amount) * 100 : 0) }}%;">
